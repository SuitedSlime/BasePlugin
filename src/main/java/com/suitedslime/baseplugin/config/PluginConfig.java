...
public class PluginConfig {
    ...
    /**
     * Creates a new config object that can be used to feth the value of a {@link PluginConfigKey}
     *
    ...
    /**
     * Creates a new cofig object that can be used to fetch the value opf a {@link PluginConfigKey}
     *
     * @param configFile   The file used to store this configuration (usually config.yml).
     * @param configHolder The class holding the default configuration option to be used if an entry cannot be found.
     * @param log          The {@link PluginLogger} to be used for any messages
     */
    ...
    /**
     * Checks to see if this config contains the give key.
     *
     ...
     *
     * @param configKey The {@link PluginConfigKey} to get the value of.
     * @return The list of integer values or an empty list if the key doesn't exist.
     */
     ...
     *
     * @param configKey The {@link PluginConfigKey} to get the value of.
     * @return The list of double values or an empty list if the key doesn't exist.
     */
    @SuppressWarnings("unchecked")
     ...
     *
     * @param configKey The {@link PluginConfigKey} to get the value of.
     * @return The long value or 0 if the key doesn't exist.
     */
     ...
     *
     * @param configKey The {@link PluginConfigKey} to get the value of.
     * @return The list of long values or an empty list if the key doesn't exist.
     */
    @SuppressWarnings("unchecked")
     ...
     *
     * @param configKey The {@link PluginConfigKey} to get the value of.
     * @return The long value or false if the key doesn't exist.
     */
     ...
     *
     * @param configKey The {@link PluginConfigKey} to get the value of.
     * @return The long value or an empty string if the key doesn't exist.
     */
     ...
     *
     * @param configKey The {@link PluginConfigKey} to get the value of.
     * @return The list of string values or an empty list if the key doesn't exist.
     */
    @SuppressWarnings("unchecked")
