...
public class PluginCommand extends Command implements PluginIdentifiableCommand {
    ...
    public PluginCommand(BasePlugin plugin, BaseCommandExecutor<? extends BasePlugin> handler, Method handlerMethod,
                         String[] names, String description, String usage, String[] tabCompletion) {
    ...
    public List<String> tabComplete(CommandSender sender, String alias, String[] args) {
        ...
        if (args.length <= tabCompletion.length) {
            ...
            if (tab.equalsIgnoreCase("<online_player>")) {
                ...
                try {
                    Method tabHandler = handlerMethod.getDeclaringClass().getMethod(tab.substring(1,
                            tab.length() - 1), CommandSender.class, String[].class);
